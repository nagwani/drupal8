 ...
 * @endcode
 */
$settings['hash_salt'] = 'VV4OwG_vqgHmb_d-pl6Q7ZNBaxkRG7-p3gLH8fMi4PDMMuABS7kjWRkres-DpUYRm2UULAv4mg';
...
if (isset($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR']) && file_exists($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/loc_stackexchange_l_local.inc'))
  require($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/loc_stackexchange_l_local.inc');
//</DDSETTINGS>
$databases['default']['default'] = array (
  'database' => 'stackexchange_l',
  'username' => 'drupaluser',
  'password' => '',
  'prefix' => '',
  'host' => '127.0.0.1',
...
$config_directories['active'] = 'sites/stackexchange-l.local/files/config_a_a3G46l5Rbv-bZqjzglwsLgYaAdNLF0HjCIYod0HBW66VkOcZosQ-EhEHnbQkEFqEC75bn-oA/active';
$config_directories['staging'] = 'sites/stackexchange-l.local/files/config_a_a3G46l5Rbv-bZqjzglwsLgYaAdNLF0HjCIYod0HBW66VkOcZosQ-EhEHnbQkEFqEC75bn-oA/staging';
